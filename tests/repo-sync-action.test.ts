...
describe('repo sync action', () => {
  ...
  it('preserves bootstrap-managed additional collection ids in .postman/resources.yaml', async () => {
    ...
    writeFileSync(
      ...
      [
        ...
        '    ../postman/additional-collections/payments.json: col-curated-payments'
      ].join('\n')
    );
    ...
    expect(resourcesYaml.cloudResources?.additionalCollections).toEqual({
      '../postman/additional-collections/payments.json': 'col-curated-payments'
    });
  });
