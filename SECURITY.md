...
Security fixes target the latest immutable release on the current supported major tracked by the rolling `vN` alias. Older tags remain published for reproducibility and are never retroactively modified.
